        ...
        <div class="card-statistic-4">
          <div class="align-items-center justify-content-between">
            <div class="row ">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                <div class="card-content">
                  <h5 class="font-15">New Visitor </h5> <span class="text-danger">Today</span>
                  <h2 class="mb-3 font-18">{{ $todayRegi }}</h2>
        ...
        <div class="card-statistic-4">
          <div class="align-items-center justify-content-between">
            <div class="row ">
              <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6 pr-0 pt-3">
                <div class="card-content">
                  <h5 class="font-15">Pre Visitor </h5><span class="text-danger">Today</span>
                  <h2 class="mb-3 font-18">{{ $todayPreRegi }}</h2>

...
return new class extends Migration
{
    ...
    {
        Schema::create('o_t_p_verified_driver_with_students', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('Status')->nullable(); // This can store the file path or URL
            $table->string('SMSID')->nullable(); // This can store the file path or URL
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('o_t_p_verified_driver_with_students');
    }
};
